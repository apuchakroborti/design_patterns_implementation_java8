...
2. When an object needs to be able to publish updates to its state, and other objects need to subscribe to receive these updates.
...
A weather data provider that publishes updates about the current temperature, humidity, and pressure to subscribed weather displays.
...
In general, the Observer design pattern is a good choice when you need to maintain consistency between related objects without making the objects tightly coupled
*
* */
