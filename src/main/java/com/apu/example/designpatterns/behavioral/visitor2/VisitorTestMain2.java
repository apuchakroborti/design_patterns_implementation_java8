...
* where we have an interface of ComputerPart, and Keyboard, Monitor, Mouse, Computer classes are the implementation of ComputerPart interface.
...
* and the visitor 'ComputerPartDisplayVisitor' is created. And finally accepts the visitors using the accept method of ComputerPart interface.
...
* Once the accept method is called, it traverse through each part of computer and call the visit method of ComputerPartVisitor for each part of the computer.
