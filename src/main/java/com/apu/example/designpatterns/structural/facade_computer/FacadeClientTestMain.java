...
It has a method, startComputer(),
that performs the steps necessary to start the computer by interacting with these internal components.

The CPU, Memory, and HardDrive classes represent the low-level interfaces to the subsystem
and contain the implementation details for their respective operations.
...
The start() method in turn calls the startComputer() method of the Computer class to
perform the necessary operations to start the computer.
* */
